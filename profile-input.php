...
<head>
    ...
    <link rel="shortcut icon" href="./public/assets/SoulMate-_4_.ico" type="image/x-icon">
...
<!-- TOAST -->
  <div style="position: relative;">
    <div style="position: absolute; top: 10px; left: 50%; transform: translateX(-50%); z-index: 2;" >
      <div class="toast d-none" style="min-width: 250px;">
        <div class="toast-header bg-primary text-white" style="background: #f5f5f5;">
          <strong class="mr-auto" style="font-size: 18px;">Location Denied</strong>
          <button type="button" class="ml-2 mb-1 close" data-dismiss="toast">
            <span >&times;</span>
          </button>
        </div>
        <div class="toast-body">
          Please enable location access and refresh the page. We need it to serve you best possible matches.
        </div>
      </div> 
    </div>
  </div>
   ...
   <div class="form-row pl-2">
     ...
     <div class="form-row mt-3 pl-2">
      <div class="col-3">
       ...
       <img id="profile-pic" src="profile-icon-png-910.png" alt="" width="180" height="180" style="border-radius: 50%; object-fit: cover;" title="Click to change">
